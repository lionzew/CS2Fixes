...
bool CS2Fixes::Load(PluginId id, ISmmAPI *ismm, char *error, size_t maxlen, bool late)
{
		...
		new CTimer(60.0f, true, []() mutable  // Repeat every 60 seconds
	{
		...
		if (isAWP) {
			...
			g_pEngineServer2->ServerCommand("ent_remove_all weapon_ak47;ent_remove_all weapon_ak47");
			...
			g_pEngineServer2->ServerCommand("sv_cheats true");
			g_pEngineServer2->ServerCommand("ent_remove_all weapon_awp;ent_remove_all weapon_deagle");
			g_pEngineServer2->ServerCommand("sv_cheats false");
